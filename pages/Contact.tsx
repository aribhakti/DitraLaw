      ...
      <div className="flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="lg:w-1/2 pt-32 pb-16 px-6 md:px-16 lg:px-20 flex flex-col justify-center bg-white order-1 transition-colors duration-300">
          <div className="max-w-xl w-full mx-auto">
            ...
            <h4 className="text-xxs font-bold tracking-[0.2em] text-primary uppercase mb-6">{t.contact.getInTouch}</h4>
            <h1 className="text-4xl md:text-6xl font-serif text-primary mb-10">{t.contact.title}</h1>

            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group">
                  <label className="block text-xxs font-bold uppercase tracking-[0.2em] text-gray-700 mb-2 group-focus-within:text-primary transition-colors">{t.contact.form.name}</label>
                  <input
                    type="text"
                    required
                ...
                <div className="group">
                  <label className="block text-xxs font-bold uppercase tracking-[0.2em] text-gray-700 mb-2 group-focus-within:text-primary transition-colors">{t.contact.form.email}</label>
                  <input
                    type="email"
                    required
                    disabled={isSubmitting}
              ...
              <div className="group">
                <label className="block text-xxs font-bold uppercase tracking-[0.2em] text-gray-700 mb-2 group-focus-within:text-primary transition-colors">{t.contact.form.subject}</label>
                <input
                  type="text"
                  required
                  disabled={isSubmitting}
              ...
              <div className="group">
                <label className="block text-xxs font-bold uppercase tracking-[0.2em] text-gray-700 mb-2 group-focus-within:text-primary transition-colors">{t.contact.form.message}</label>
                <textarea
                  rows={4}
                  required
                  disabled={isSubmitting}
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className={`group mt-8 flex items-center gap-4 px-8 py-4 md:py-3 font-bold tracking-[0.2em] uppercase text-xxs transition-all duration-300 w-full md:w-auto justify-center bg-primary text-white hover:bg-secondary shadow-lg`}
              >
                {isSubmitting ? (
        ...
        <div className="lg:w-1/2 bg-surface-dark text-white p-8 lg:p-16 flex flex-col justify-center relative overflow-hidden order-2 group min-h-[400px]">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-8">
                <div className="flex gap-6 group/item pointer-events-auto">
                  ...
                  <div>
                    <p className="text-xxs font-bold uppercase tracking-[0.2em] text-stone-400 mb-1">{t.contact.office.address}</p>
                    <div className="text-stone-300 font-light leading-relaxed text-sm">
                      {CONTACT_INFO.address.map((line, i) => (
                        <p key={i}>{line}</p>
                      ))}
                    </div>
                    <a href={googleMapsUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-secondary text-xxs mt-2 hover:underline uppercase tracking-wider">
                ...
                <div className="flex gap-6 group/item pointer-events-auto">
                  ...
                  <div>
                    <p className="text-xxs font-bold uppercase tracking-[0.2em] text-stone-400 mb-1">{t.contact.office.email}</p>
                ...
                <div className="flex gap-6 group/item pointer-events-auto">
                  ...
                  <div>
                    <p className="text-xxs font-bold uppercase tracking-[0.2em] text-stone-400 mb-1">{t.contact.office.phone}</p>
