        ...
        <div className="flex flex-wrap gap-3 mb-12 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          {categories.map((cat) => (
            <button
              ...
              className={`px-5 py-2 rounded-full text-xxs font-bold uppercase tracking-[0.2em] transition-all duration-300 ${activeCategory === cat
          ...
          {filteredInsights.map((item, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 text-xxs text-gray-400 mb-3 uppercase tracking-[0.2em]">
                <Calendar size={12} /> {new Date(item.date).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric',
                  weekday: 'long',
