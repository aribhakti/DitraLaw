    ...
    <div className="bg-white dark:bg-primary min-h-screen transition-colors duration-300">
      ...
      <div className="bg-surface dark:bg-surface-dark pt-32 pb-16 md:pt-40 md:pb-24 border-b border-gray-100 dark:border-white/5 transition-colors duration-300">
        <div className="container mx-auto px-6 md:px-12">
          <h4 className="text-xxs font-bold tracking-[0.2em] text-secondary uppercase mb-6 animate-fade-in">{t.nav.careers}</h4>
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:w-2/3">
             ...
             <div className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
               ...
               <div className="bg-gray-50 dark:bg-surface-dark border border-gray-100 dark:border-white/5 p-10 text-center rounded-sm">
                 ...
                 <Link 
                   to="/contact" 
                   className="inline-flex items-center gap-3 px-6 py-3 bg-primary dark:bg-white text-white dark:text-primary font-bold tracking-[0.2em] uppercase text-xxs hover:bg-secondary dark:hover:bg-gray-200 transition-colors shadow-lg"
                 >
          ...
          <div className="lg:w-1/3 space-y-12">
             <div className="bg-surface-dark text-white p-8 relative overflow-hidden border-t-4 border-primary">
               ...
               <Link to="/contact" className="text-xxs font-bold uppercase tracking-[0.2em] text-secondary hover:text-white transition-colors relative z-10 flex items-center gap-3">
