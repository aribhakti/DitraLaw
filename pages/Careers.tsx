    ...
    <div className="bg-white dark:bg-primary min-h-screen pt-20 transition-colors duration-300">
      ...
      <div className="bg-surface dark:bg-[#111625] py-20 md:py-24 border-b border-gray-100 dark:border-white/5 transition-colors duration-300">
        <div className="container mx-auto px-6 md:px-12">
          <h4 className="text-[10px] font-bold tracking-widest text-secondary uppercase mb-6 animate-fade-in">{t.nav.careers}</h4>
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-2/3">
             <div className="mb-16 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
               ...
               <div className="prose prose-lg prose-gray dark:prose-invert font-light leading-relaxed">
                 <p className="text-base md:text-lg">{t.careers.cultureDesc}</p>
                 <p className="text-base md:text-lg">We are a firm that values diversity, innovation, and integrity. Whether you are an experienced associate or a fresh graduate, we offer an environment where your skills are honed and your contributions are recognized.</p>
               </div>
             </div>
             ...
             <div className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
               ...
               {/* No openings placeholder for now */}
               <div className="bg-gray-50 dark:bg-[#111625] border border-gray-100 dark:border-white/5 p-10 text-center rounded-sm">
                 ...
                 <p className="text-gray-500 dark:text-gray-400 font-light mb-6 text-sm">
                   {t.careers.noOpenings}
                 </p>
                 <Link 
                   to="/contact" 
                   className="inline-flex items-center gap-2 px-6 py-3 bg-primary dark:bg-white text-white dark:text-primary font-bold tracking-widest uppercase text-[10px] hover:bg-secondary dark:hover:bg-gray-200 transition-colors"
                 >
          ...
          <div className="lg:w-1/3 space-y-10">
             <div className="bg-[#1c1917] text-white p-8 relative overflow-hidden border-t-4 border-primary">
               ...
               <Link to="/contact" className="text-[10px] font-bold uppercase tracking-widest text-secondary hover:text-white transition-colors relative z-10 flex items-center gap-2">
                 Contact HR <ArrowRight size={12}/>
               </Link>
             </div>
          </div>
